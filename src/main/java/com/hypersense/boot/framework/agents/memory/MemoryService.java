...
public class MemoryService {
    ...
    private final ZhipuAiClient embeddingClient;
    private final ChatModel chatModel;
    private final AgentProperties.MemoryConfig config;

    public MemoryService(MemoryRepository repository, ZhipuAiClient embeddingClient,
    ...
    private List<float[]> batchEmbed(List<String> texts) {
        ...
        try {
            ...
            EmbeddingResponse response = embeddingClient.embeddings().createEmbeddings(params);
            if (response.isSuccess() && response.getData() != null) {
                ...
                if (result.getData() != null && !result.getData().isEmpty()) {
                    return result.getData().stream()
                            ...
                            .map(e -> {
                                List<Double> vec = e.getEmbedding();
                ...
                log.warn("MemoryService: 批量 Embedding 失败: code={}, msg={}",
